...
$JqcLoader.importComponents('com.jquery', ['jquery', 'keycode', 'version'])
    ...
    .importScript(LIB_ROOT_PATH.concat('com/lifeonwalden/app/js/config_new.js'))
    .execute(function() {
        const T = $.jqcToolkit;
        ...
        $.App.prototype.fetchDataAndFillDxDataGrid = function (api, params) {
            var _this = this;
            this.loading.show();
            this.fetchData(api, params).then(res => {
                _this.fillData(res.result);
                _this.loading.hide();
            });
        };
