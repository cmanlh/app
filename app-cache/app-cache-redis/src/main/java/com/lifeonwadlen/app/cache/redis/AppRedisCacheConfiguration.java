 ...
 * Start with {@link AppRedisCacheConfiguration#defaultCacheConfig()} and customize {@link AppRedisCache} behaviour from there
 * on.
 *
...
public class AppRedisCacheConfiguration {
    ...
    private AppRedisCacheConfiguration(Duration ttl, Boolean cacheNullValues, Boolean usePrefix, String keyPrefix,
    ...
    /**
     * Default {@link AppRedisCacheConfiguration} using the following:
     * <dl>
     ...
     * </dl>
     *
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public static AppRedisCacheConfiguration defaultCacheConfig() {

        DefaultFormattingConversionService conversionService = new DefaultFormattingConversionService();

        registerDefaultConverters(conversionService);

        return new AppRedisCacheConfiguration(Duration.ZERO, true, true, null,
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration entryTtl(Duration ttl) {

        Assert.notNull(ttl, "TTL duration must not be null!");

        return new AppRedisCacheConfiguration(ttl, cacheNullValues, usePrefix, keyPrefix, keySerializationPair,
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration prefixKeysWith(String prefix) {

        Assert.notNull(prefix, "Prefix must not be null!");

        return new AppRedisCacheConfiguration(ttl, cacheNullValues, true, prefix, keySerializationPair, valueSerializationPair,
                conversionService);
    }

    /**
     * Disable caching {@literal null} values. <br />
     * <strong>NOTE</strong> any {@link Cache#put(Object, Object)} operation involving
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration disableCachingNullValues() {
        return new AppRedisCacheConfiguration(ttl, false, usePrefix, keyPrefix, keySerializationPair, valueSerializationPair,
                conversionService);
    }
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration disableKeyPrefix() {

        return new AppRedisCacheConfiguration(ttl, cacheNullValues, false, keyPrefix, keySerializationPair,
                valueSerializationPair, conversionService);
    }
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration withConversionService(ConversionService conversionService) {
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration serializeKeysWith(SerializationPair<String> keySerializationPair) {
     ...
     * @return new {@link AppRedisCacheConfiguration}.
     */
    public AppRedisCacheConfiguration serializeValuesWith(SerializationPair<?> valueSerializationPair) {
