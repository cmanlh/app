 ...
 */
public class _RedisCacheManager extends AbstractTransactionSupportingCacheManager {

	private final Log logger = LogFactory.getLog(_RedisCacheManager.class);
	...
	/**
	 * Construct a {@link _RedisCacheManager}.
	 *
	 * @param redisOperations
	 */
	@SuppressWarnings("rawtypes")
	public _RedisCacheManager(RedisOperations redisOperations) {
		this(redisOperations, Collections.<String> emptyList());
	}

	/**
	 * Construct a static {@link _RedisCacheManager}, managing caches for the specified cache names only.
	 *
	 * @param redisOperations
	 * @param cacheNames
	 * @since 1.2
	 */
	@SuppressWarnings("rawtypes")
	public _RedisCacheManager(RedisOperations redisOperations, Collection<String> cacheNames) {
		this(redisOperations, cacheNames, false);
	}

	/**
	 * Construct a static {@link _RedisCacheManager}, managing caches for the specified cache names only. <br />
	 * <br />
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public _RedisCacheManager(RedisOperations redisOperations, Collection<String> cacheNames, boolean cacheNullValues) {
	...
	/**
	 * If set to {@code true} {@link _RedisCacheManager} will try to retrieve cache names from redis server using
